...
class IEEE118EOL(Network):
    ...
    def _create_generators(self):
        ...
        WindGenerator(id=55,   bus=self.buses[  0],   pb=self.sb,   p_min_input=0.0,   p_max_input=10.0,   cost_b_input=0.0)
        WindGenerator(id=56,   bus=self.buses[  7],   pb=self.sb,   p_min_input=0.0,   p_max_input=10.0,   cost_b_input=0.0)
        WindGenerator(id=57,   bus=self.buses[ 14],   pb=self.sb,   p_min_input=0.0,   p_max_input=15.0,   cost_b_input=0.0)
        WindGenerator(id=58,   bus=self.buses[ 23],   pb=self.sb,   p_min_input=0.0,   p_max_input=15.0,   cost_b_input=0.0)
        WindGenerator(id=59,   bus=self.buses[ 53],   pb=self.sb,   p_min_input=0.0,   p_max_input=30.0,   cost_b_input=0.0)
        WindGenerator(id=60,   bus=self.buses[ 58],   pb=self.sb,   p_min_input=0.0,   p_max_input=20.0,   cost_b_input=0.0)
        WindGenerator(id=61,   bus=self.buses[ 68],   pb=self.sb,   p_min_input=0.0,   p_max_input=20.0,   cost_b_input=0.0)
        WindGenerator(id=62,   bus=self.buses[ 73],   pb=self.sb,   p_min_input=0.0,   p_max_input=10.0,   cost_b_input=0.0)
        WindGenerator(id=63,   bus=self.buses[ 79],   pb=self.sb,   p_min_input=0.0,   p_max_input=15.0,   cost_b_input=0.0)
        WindGenerator(id=64,   bus=self.buses[ 84],   pb=self.sb,   p_min_input=0.0,   p_max_input=10.0,   cost_b_input=0.0)
        WindGenerator(id=65,   bus=self.buses[109],   pb=self.sb,   p_min_input=0.0,   p_max_input=20.0,   cost_b_input=0.0)
